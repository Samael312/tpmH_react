...
function UpcomingClassCard({ cls }: { cls: any }) {
  ...
  return (
    <div className={`group bg-white/90 backdrop-blur-xl rounded-2xl border
                     border-white/80 shadow-lg shadow-slate-100/80 border-l-4
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center self-end sm:self-center">
          <span className="w-9 h-9 rounded-xl bg-slate-50 group-hover:bg-pink-50 group-hover:text-pink-600 text-slate-400 flex items-center justify-center transition-colors">
