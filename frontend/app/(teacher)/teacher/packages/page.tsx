  ...
  return (
    <div className="min-h-screen bg-slate-50 relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        {/* Form crear/editar */}
        {showForm && (
          <div className="bg-white/85 backdrop-blur-xl rounded-[2rem] border border-white
                ...
                <div key={pkg.id} className={`bg-white/80 backdrop-blur-xl rounded-2xl border border-white
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-1.5 bg-slate-100
                                 hover:bg-slate-200 text-slate-700 text-xs font-bold py-2.5 rounded-xl transition-colors"
                    >
                    ...
                    {pkg.is_active && (
                      <button
                        ...
                        className="w-10 flex items-center justify-center bg-red-50 text-red-400
                                   hover:bg-red-100 rounded-xl transition-colors flex-shrink-0"
                      >
