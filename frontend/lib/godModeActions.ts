...
export const GOD_MODE_ACTIONS: GodModeAction[] = [
  ...
  // ── Reseñas ───────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { name: "total_completed_classes", label: "Clases completadas con este profesor (opcional)", type: "number", optionalNumber: true,
        helpText: "Recomendado en reseñas legacy: las clases de la plataforma anterior no están en este sistema, así que no se pueden calcular solas. Si se deja vacío y el alumno tiene cuenta acá, se calculará en vivo (probablemente 0)." },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "total_completed_classes", label: "Clases completadas con este profesor (corrección opcional)", type: "number", optionalNumber: true },
